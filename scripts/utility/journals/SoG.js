...
const LAYOUT_ROOT = "/modules/ts-pf2e-utility/layout/SoG";

export class SoGJournalSheet extends TaleSaleJournalSheet {
  static get journalSheetConfig() {
    return {
      className: "SoG",
      variablePrefix: "sog",
      titleTextClass: "sog-window-title-text",
      ...
      h3Color: "#1f1a17",
      h4Color: "#1f1a17",
      traitColor: "rgb(17, 65, 70)",
      gmVisibilityBackground: "#dcdce3",
      blockquoteTextColor: "rgb(17, 65, 70)",
      blockquoteBackgroundColor: "#f8f8eb",
      blockquoteRuleColor: "rgb(17, 65, 70)",
