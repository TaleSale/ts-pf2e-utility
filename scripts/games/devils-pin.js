...
function buildSummaryUi(definition, state) {
  ...
  return {
    ...
    footerButtons: {
      ...
      resetRound: gt(definition, "Buttons.ResetRound", isRussianLocale() ? "Раунд" : "Round"),
    ...
    try {
      ...
      if (game.user.isGM) {
        ...
        if (state.phase === "join") {
          ...
          roundButton.label = ui.footerButtons.start;
